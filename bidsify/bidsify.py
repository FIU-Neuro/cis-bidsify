...
def _get_parser():
    ...
    DESC = """
    BIDS conversion and anonymization.
    ...
    CLI:
        bidsify \\
            -d /mnt/d/Documents/McMakin_EMU-000-R01_{subject}{session}-{session}.tar.gz \\
            -f /mnt/d/Documents/McMakin_EMUR01.py \\
            -s 4000 \\
            -ss S1 \\
            -o /mnt/d/Documents/bidsify_test
    DOCKER:
        docker run -v /mnt:/mnt <img_name> \\
            -d /mnt/d/Documents/McMakin_EMU-000-R01_{subject}{session}-{session}.tar.gz \\
            -f /mnt/d/Documents/McMakin_EMUR01.py \\
            -s 4000 \\
            -ss S1 \\
            -o /mnt/d/Documents/bidsify_test
    SINGULARITY:
        singularity run --cleanenv <img_name> \\
            -d /mnt/d/Documents/McMakin_EMU-000-R01_{subject}{session}-{session}.tar.gz \\
            -f /mnt/d/Documents/McMakin_EMUR01.py \\
            -s 4000 \\
            -ss S1 \\
